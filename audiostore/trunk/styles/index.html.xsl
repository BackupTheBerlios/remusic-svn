...
<xsl:stylesheet 
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        ...
        <div class="navigation">
          ...
          <a>
            <xsl:attribute name="href">
              ...
              <xsl:value-of select="substring-after(audiolist/path,'/')"/>
        ...
        <div class="generated">
          ...
          <a href="{$remus.url}">
            <xsl:text>remus.audiostore </xsl:text><xsl:value-of select="$remus.version"/>
          </a>
  ...
  <xsl:template match="audiolist">
    <table xmlns="http://www.w3.org/1999/xhtml" class="audiolist" cellspacing="0">
      <thead>
        <tr class="colhead">
          <th>
            <a href="?order=au_artist">Artist:</a>
          </th>
          <th>
            <a href="?order=au_album&amp;order=au_track_number">Album: </a>
          </th>
          <th>
        ...
        <tr class="subtitle">
          <th colspan="4">Number of songs: <xsl:value-of select="@length"/></th>
        </tr>
      </thead>
      <tbody>
  ...
  <xsl:template match="audioclip">
    <tr xmlns="http://www.w3.org/1999/xhtml">
      ...
      <td>
        <a class="musiclink">
          <xsl:attribute name="href">
            <xsl:value-of select="$audiostore.root"/>artist/<xsl:value-of select="artist"/>/
          </xsl:attribute>
      ...
      <td>
        <a class="musiclink">
          <xsl:attribute name="href">
            <xsl:value-of select="$audiostore.root"/>album/<xsl:value-of select="album"/>/
          </xsl:attribute>
